...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('dennisthepeasant.vns', 'address', True),  # passes because vns_utils converts to bytes :/
        ('autonomouscollective.vns', 'address', True),
        ...
        ('0xname.vns', 'address', True),  # 0x in name is fine, if it is not a TLD
        ...
        (('dennisthepeasant.vns', 0), '(address,int128)', True),
