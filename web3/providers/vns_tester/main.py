...
class AsyncEthereumTesterProvider(BaseProvider):
    ...
    """
    def __init__(self):
        self.vns_tester = EthereumTesterProvider()
...
class EthereumTesterProvider(BaseProvider):
    ...
    def __init__(self, ethereum_tester=None, api_endpoints=None):
        ...
        from vns_tester import EthereumTester
        ...
        if ethereum_tester is None:
            ...
            raise TypeError(
                "Expected ethereum_tester to be of type `vns_tester.EthereumTester` or "
                ...
                "vns-tester documentation. https://github.com/ethereum/vns-tester."
            )
