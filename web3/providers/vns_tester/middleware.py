...
transaction_params_formatter = compose(
    # remove nonce for now due to issue https://github.com/ethereum/vns-tester/issues/80
...
ethereum_tester_middleware = construct_formatting_middleware(
    request_formatters={
        # Bbbbbbbb        'vns_getBlockByNumber': apply_formatters_to_args(
        ...
        'vns_getCode': apply_formatters_to_args(
            identity,
            apply_formatter_if(is_not_named_block, to_integer_if_hex),
        ),
        # EVM
